...
g = plt.figure(2)
plt.hist(feature2_class1_arr, density=True, bins = 32, color ="magenta", alpha=0.5, label="feature2 class1")
plt.hist(feature2_class2_arr, density=True, bins = 32, color ="brown", alpha=0.5, label="feature2 class2")
