...
#trainingdata1=list_of_each_pair1[int(0.2*len(list_of_each_pair1)):int(len(list_of_each_pair1))]
#trainingdata2=list_of_each_pair2[int(0.2*len(list_of_each_pair2)):int(len(list_of_each_pair2))]
#testdata=list_of_each_pair1[0:int(0.2*len(list_of_each_pair1))]+list_of_each_pair2[0:int(0.2*len(list_of_each_pair2))]
#==================================================================
#Plotting the given data class1&class2
#plt.scatter(*zip(*list_of_each_pair1),c="black")
#plt.scatter(*zip(*list_of_each_pair2),c="red")
#==================================================================
...
for i in testdata1:
    ...
    if (p1-p2)>0:
        ...
        testdata1_classify.append(i)
    elif (p1-p2)<0 or p1==p2:
        class1_classified2.append(i)
        testdata2_classify.append(i)
...
plt.scatter(*zip(*testdata1_classify),c="purple")
plt.scatter(*zip(*testdata2_classify),c="cyan")
plt.legend(['class1_train','class2_train','class1_test','class2_test'])
plt.title('Non-Lineraly separable dataset')
